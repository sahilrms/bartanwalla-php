                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    try {
                      ...
                      $stmt->execute();
                      foreach ($stmt as $row) {
                        $photo_list = (!empty($row['photo'])) ? explode(',', $row['photo']) : []; // Split the photo string
                        $counter = ($row['date_view'] == $now) ? $row['counter'] : 0;
                        echo "<tr>";
                        echo "<td>" . $row['name'] . "</td>";
                        echo "<td>";

                        // Loop through the photo list and display each image
                        foreach ($photo_list as $photo) {
                          $image_path = '../images/' . $photo;
                          echo "<img src='" . $image_path . "' height='50px' width='50px' style='margin-right: 5px;'>"; // Displaying each photo as a thumbnail
                        }
